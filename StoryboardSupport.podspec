...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ...
                   DESC
  s.homepage     = "http://EXAMPLE/StoryboardSupport"
  ...
  # s.authors      = { "Maximilian Tagher" => "feedback.tagher@gmail.com", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Maximilian Tagher', 'other author'

  # Specify the location from where the source should be retrieved.
  #
  s.source       = { :git => "http://EXAMPLE/StoryboardSupport.git", :tag => "0.0.1" }
